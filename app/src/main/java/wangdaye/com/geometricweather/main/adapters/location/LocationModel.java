...
public class LocationModel {
    ...
    public LocationModel(
        ...
        if (location.getWeather() != null && location.getWeather().getDailyForecast() != null 
                && !location.getWeather().getDailyForecast().isEmpty()) {
            Daily daily = location.getWeather().getDailyForecast().get(0);
            this.weatherCode = (location.isDaylight() && daily.day() != null)
                    ? daily.day().getWeatherCode()
                    : (!location.isDaylight() && daily.night() != null)
